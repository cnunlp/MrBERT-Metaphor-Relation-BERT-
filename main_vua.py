...
def train(tr_raw_vua,val_raw_vua, test_raw_vua, device, model_dir, epochs, max_len, batch_size, learning_rate, max_grad_norm, output_dir, repr, integrate, relmodel):
    '''模型训练
    '''
    ...
    for epoch in range(epochs):
        ...
        # 打印信息
        # print("{:15}{:<.3f}".format('val loss:', val_loss / nb_val_steps))
...
def main():
    ...
    train( raw_vua_train, raw_vua_val, raw_vua_test, device, args.bert_base_model_dir, args.num_epochs, args.max_len, args.batch_size, args.lr, args.max_grad_norm, args.output_dir, args.repr, args.integrate, args.relmodel)
